...
#define DEFAULT_CRASH_THRESHOLD_G 4.0f
#define DEFAULT_HARSH_BRAKING_THRESHOLD_G 2.0f
#define DEFAULT_HARSH_ACCEL_THRESHOLD_G 1.5f
#define DEFAULT_HARSH_CORNERING_THRESHOLD_G 2.0f
