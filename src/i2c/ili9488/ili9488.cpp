...
void drawMainScreen() {
  ...
  for (int i = 0; i < numTrees; i++) {
    ...
    if (y < 60 && abs(x - 120) < 40) tooCloseToRoad = true;
    if (y >= 60 && y < 120 && abs(x - (120 + (60 * (y - 60) / 60.0))) < 40) tooCloseToRoad = true;
    if (y >= 120 && y < 220 && abs(x - (180 - (120 * (y - 120) / 100.0))) < 40) tooCloseToRoad = true;
    if (y >= 220 && abs(x - (60 + (60 * (y - 220) / 100.0))) < 40) tooCloseToRoad = true;
